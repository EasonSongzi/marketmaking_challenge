...
class MarketMaker:
    ...
    def quote(self, option: BinaryOption, counterparty_id: int) -> Quote:  # type: ignore[empty-body]
        ...
        residual_correlation: float = self.warm_up_statistics.rate_adjusted_residual_correlation
        half_width: int = 8 if residual_correlation > 0.50 else (5 if repeat_request else 4)
